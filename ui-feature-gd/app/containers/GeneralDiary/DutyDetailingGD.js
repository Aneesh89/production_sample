...
export function DutyDetailingGD(props) {
    ...
    <>
      <Formik
        ...
        onSubmit={(values, { setSubmitting, resetForm, setFieldError }, actions) => {
          ...
          let tempJsonSort = {}
          dutyDetail.map((d => {
            dutyDetailsArray.push({
              "officerPenNo": d.officerPenNo,
              "officerName": d.officerName,
              "dutyType": d.dutyType.key
            });
          }));
      ...
      >
        {({ errors, touched, isSubmitting, dirty, resetForm, values, setFieldValue, setFieldTouched }) => (
          <Col  >
            <DutyDetails data={dutyDetail} setDutyDetail={setDutyDetail} />
            <Form>
              <FormGroup row>
                <Col>
                  <Row>
