...
function ClosingGDComments(props) {
 ...
 //Submit Closing GD Review Comment by ImmediateSupervisor

    async function saveCommentsList(tempJsonSort) {
        await http({
            method: 'POST',
            url: ADD_CLOSING_GD_COMMENTS,
            data: tempJsonSort,
        })
        ...
        <>
            <Formik
                ...
                onSubmit={(values, { setSubmitting, resetForm }) => {
                    ...
                    temp = {
                        "disrict": props.closingGdList.District,
                        "date": props.closingGdList.date,
                        "unit": props.closingGdList.unit,
