...
export const FlatNav = [
  ...
  },
  {
    ...
    parentId: 11,
    icon: 'pe-7s-edit',
    label: 'Search and View GD',
    to: '/SearchandViewGD',
    component: 'SearchandViewGD',
  },
  {
    id: 14,
    parentId: 11,
    icon: 'pe-7s-edit',
    label: 'Assume GD Charge',
    to: '/AssumeGDCharge',
    component: 'AssumeGDCharge',
  },
  {
    id: 15,
    parentId: 11,
    icon: 'pe-7s-edit',
    label: 'Assign GD Charge',
    to: '/AssignGDCharge',
    component: 'AssignGDCharge',
  },
  {
    id: 16,
    parentId: 11,
